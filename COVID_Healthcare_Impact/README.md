...
🖼️ Screenshot Previews (Phase 1)
You can view all screenshots at: https://github.com/Margaret-Johnson-ai/Data-Analytics-Portfolio/tree/main/COVID_Healthcare_Impact/Screenshots
💡 What I Learned
•	- Managing and cleaning multi-source public datasets
•	- Using KNIME to automate data prep and transformations
•	- Creating a structured, recruiter-ready GitHub project
•	- Documenting work clearly with screenshots and notes
🧭 What’s Coming in Phase 2
•	- Merge final datasets into one unified table
•	- Calculate death rates per county and income brackets
•	- Explore trends with scatter plots and bar charts
•	- Write insights summary and upload visualizations to GitHub
🙋🏽‍♀️ About Me
